...
class NewTh implements Runnable {
    ...
    public void consume() {
        try {
            ...
            System.out.println("Consumed data:" + consumed);
            Thread.sleep(3000);
